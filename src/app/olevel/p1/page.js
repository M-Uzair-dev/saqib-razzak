          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div ref={addToContentRef} className="mb-16">
                <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Study Materials & Notes</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Computer Systems", description: "Comprehensive theory notes", pages: "24 pages" },
                    { title: "Data Representation", description: "Number systems and binary", pages: "18 pages" },
                    { title: "Computer Networks", description: "Network fundamentals", pages: "32 pages" },
                    { title: "System Development", description: "SDLC and methodologies", pages: "28 pages" },
                    { title: "Programming Logic", description: "Algorithms and flowcharts", pages: "22 pages" },
                    { title: "Database Systems", description: "Database design concepts", pages: "26 pages" }
                  ].map((pdf, index) => (
