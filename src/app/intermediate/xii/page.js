          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div ref={addToContentRef} className="mb-16">
                <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Class XII Final Year Materials</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Mathematics XII", description: "Advanced calculus & statistics", pages: "70 pages" },
                    { title: "Computer Science XII", description: "Advanced programming & databases", pages: "55 pages" },
                    { title: "Physics XII", description: "Modern physics & electronics", pages: "65 pages" },
                    { title: "Chemistry XII", description: "Organic & physical chemistry", pages: "60 pages" },
                    { title: "Board Exam Strategies", description: "Exam techniques and time management", pages: "25 pages" },
                    { title: "Past Paper Solutions", description: "Complete solved papers with explanations", pages: "80 pages" }
                  ].map((pdf, index) => (
