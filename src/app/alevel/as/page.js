          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div ref={addToContentRef} className="mb-16">
                <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">AS Level Study Resources</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Computer Systems Architecture", description: "Detailed hardware & software concepts", pages: "38 pages" },
                    { title: "Algorithms & Data Structures", description: "Advanced programming concepts", pages: "42 pages" },
                    { title: "Software Development", description: "OOP and development methodologies", pages: "35 pages" },
                    { title: "Database Design", description: "Normalization and SQL queries", pages: "30 pages" },
                    { title: "Communication & Networks", description: "Network protocols and security", pages: "40 pages" },
                    { title: "AS Past Papers Solutions", description: "Worked solutions and mark schemes", pages: "65 pages" }
                  ].map((pdf, index) => (
