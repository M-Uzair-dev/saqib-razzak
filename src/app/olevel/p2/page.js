            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div ref={addToContentRef} className="text-center">
                <div className="bg-white rounded-2xl p-12 shadow-lg">
                  ...
                  <p className="text-xl text-gray-600 mb-2">Notes for <span className="text-[#f7991B] font-semibold">O Level Paper 2</span> will be added soon!</p>
                  <p className="text-gray-500">Stay tuned for comprehensive programming materials and practical examples.</p>
                </div>
              </div>
            </div>
          </section>
