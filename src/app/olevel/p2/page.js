          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div ref={addToContentRef} className="mb-16">
                <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Programming Materials & Code Examples</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Python Programming", description: "Complete Python tutorial & examples", pages: "45 pages" },
                    { title: "Pseudocode Guide", description: "Step-by-step pseudocode writing", pages: "20 pages" },
                    { title: "Flowcharts Manual", description: "Visual programming concepts", pages: "28 pages" },
                    { title: "Algorithm Design", description: "Problem-solving techniques", pages: "35 pages" },
                    { title: "Data Structures", description: "Arrays, lists, and more", pages: "30 pages" },
                    { title: "Past Paper Solutions", description: "Solved programming questions", pages: "52 pages" }
                  ].map((pdf, index) => (
